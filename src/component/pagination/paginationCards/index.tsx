...
const PaginationCards = ({ sumCart, sumElementNow, setSumPagination }:IProps) => {
	...
	return (
		<div className='cards-pagination'>
			{numElem.map((e, i) => (
				<div onClick={()=> setPaginationActive(i)} className={`cards-pagination__item ${paginationActive === i? 'active-pag':''}`}>{e}</div>
			))}
		</div>
	)
}
