	...
	return (
		<section className='checkout-form'>
			...
			<label className='checkout-form__label'>
				...
				<p className='checkout-form__desc checkout-form__desc_bottom'>Зареєструватися</p>
			</label>
			<p className='checkout-form__desc checkout-form__desc_top'>Уточнення до замовлення</p>
			<textarea className='checkout-form__textarea' placeholder='Оберіть способ оплати'></textarea>
		</section>
	)
};
